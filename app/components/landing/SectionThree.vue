...
import type { LandingSectionThreeContent } from '~/data/landingDefaults'
      ...
      <div class="lg:w-auto flex flex-col justify-start items-start gap-14">
        ...
        <div class="self-stretch flex justify-start items-start gap-6">
          <div class="w-10 h-[460px] relative hidden md:block flex-shrink-0">
            ...
            >
              <img v-if="content.timelineMarkerImage?.url" :src="content.timelineMarkerImage.url" :alt="content.timelineMarkerImage.alt" class="w-40 h-40">
            </div>
          </div>
