...
<template>
  <section
    id="contact-form"
    class="relative py-16 md:py-24 lg:py-32 px-6 md:px-12 lg:px-[120px] min-h-[700px] md:min-h-[800px] flex items-center bg-bg-primary overflow-hidden"
  >
    ...
    <div
      class="absolute inset-0 bg-gradient-to-r from-bg-primary via-bg-primary/80 to-transparent z-0"
    />
    ...
    <div class="max-w-[1440px] mx-auto relative z-10 w-full">
      <div class="flex flex-col lg:flex-row lg:items-center justify-between gap-12">
        <div class="w-full lg:w-1/3 text-center lg:text-left">
          <h2
            class="text-3xl md:text-4xl lg:text-[56px] leading-tight lg:leading-[60px] font-medium text-white whitespace-pre-line"
          >
            {{ content.title }}
          </h2>
        </div>
        ...
        <div
          class="w-full lg:w-[600px] bg-bg-primary/80 backdrop-blur-md border border-white/10 rounded-3xl p-6 md:p-8 lg:p-10 shadow-2xl"
        >
          ...
          <form class="space-y-5" @submit.prevent="submitForm">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
              <div class="space-y-1.5">
                ...
                <input
                  ...
                  class="w-full h-12 px-4 bg-white rounded-lg text-gray-900 placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500"
                >
              </div>
              <div class="space-y-1.5">
            ...
            <div class="space-y-1.5">
              ...
              <div class="flex">
                <div
                  class="h-12 px-2.5 md:px-3 bg-white border-r border-gray-200 rounded-l-lg flex items-center text-gray-500 min-w-[64px] md:min-w-[70px]"
                >
                ...
                <input
                  v-model="form.phone"
                  type="text"
                  placeholder="+62 (851) 000-0000"
                  class="flex-1 h-12 px-4 bg-white rounded-r-lg text-gray-900 placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500"
                >
              </div>
            </div>
            ...
            <div class="space-y-1.5">
              ...
              <textarea
                ...
                class="w-full p-4 bg-white rounded-lg text-gray-900 placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 resize-none"
              />
            </div>
